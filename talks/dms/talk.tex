...
\begin{frame}{glacier models}

\begin{itemize}
\item<1> glacier problem:
   \begin{quote}
   given geometry of glacier, and stress boundary conditions, determine velocity of ice
   \end{quote}
\item<2> glacier problem:
   \begin{quote}
   given climate and topography, determine glaciated area, thicknesses of glaciers, and velocity of ice
   \end{quote}
\end{itemize}
\end{frame}
