...
We show in this section that for a variety of different fluxes $\bQ_n$, variational inequality \eqref{eq:theVI} is a well-posed problem.  The \emph{a posteriori} analysis of conservation errors in section \ref{sec:timeseries} (below) assumes that these problems are well-posed.
