...
Each time-step requires the solution of a (continuous) free-boundary problem in space.  An immediate question is:
  ...
  \end{enumerate}
  \end{quote}
The answer to (i) depends on the form of the flux, but by examining the variational inequality (weak) form we can show that the answer is often ``yes,'' although sometimes subject to time-step restrictions (Section \ref{sec:wellposed}).
