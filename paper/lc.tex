...
\item If $S \subset \Omega_n^0$ is open then \eqref{eq:semiconstraint} applies a.e.~$x\in S$.
\end{enumerate}
\end{theorem}
...
If $1<p<2$ then we have to work harder.  Showing coercivity is possible, though not via condition \eqref{eq:Qncoercive}.  Using \eqref{eq:pinequality}, \eqref{eq:smallpbound}, and \eqref{eq:poincare} gives
\begin{align*}
  &\ip{A_n(u) - A_n(v)}{u-v} \\
